...
//                     <h4>${row.name}</h4> 
//                     <p>Date: ${row.date}</p>
//                     <h4>Price: Regular ${row.price.regular}, VIP ${row.price.vip}, Premium ${row.price.premium}</h4>
//                 </div>
//                 <button class="orderBtn" onclick="buyTickets('${row.name}', '${row.date}')">Buy Tickets</button>  
